moving_clear_cen = rosbag('moving_clear_cen.bag');
moving_clear_cenSelectTopic = select(moving_clear_cen,'Topic','/gps_data_lab2');
s_msgs = readMessages(moving_clear_cenSelectTopic,'DataFormat','struct');
s_msgs{1}
