stat_build_west = rosbag('stat_build_west.bag');
stat_build_westSelectTopic = select(stat_build_west,'Topic','/gps_data_lab2');
s_msgs = readMessages(stat_build_westSelectTopic,'DataFormat','struct');
s_msgs{1}
