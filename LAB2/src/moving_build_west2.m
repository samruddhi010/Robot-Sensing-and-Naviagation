moving_build_west = rosbag('moving_build_west.bag');
moving_build_westSelectTopic = select(moving_build_west,'Topic','/gps_data_lab2');
s_msgs = readMessages(moving_build_westSelectTopic,'DataFormat','struct');
s_msgs{1}
